...
int main(int argc,char** argv){
  ...
  Double_t xbj, cs_qe, cs_dis, cs_rad,cs_born,cs_el;
  TString Target;
  ...
  if(bAsk){
    cerr<<" Target (H,D2,H3,He3,He4,C12,Al,Ca40,Ca48) = "; cin >> Target;
  ...
  TString Target_Input = Form("/home/shujie/jlab/XEMC/XEMC_Clean/input/%s_Input.dat",Target.Data());	
  ...
  cerr <<"------------------------------------------------------------------------"<<endl;
  cerr << Form("@@@ XS_QE = %e, XS_DIS = %e, XS_Born = %e, XS_Rad = %e nb/sr/MeV, XS_Elastic= %e", cs_qe, cs_dis, cs_born,cs_rad, cs_el)<<endl;
  cerr <<"------------------------------------------------------------------------"<<endl;
  cerr <<"------------------------------------------------------------------------"<<endl;
  return 0;
}
