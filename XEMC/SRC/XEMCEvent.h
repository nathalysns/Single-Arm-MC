...
//  The unit of the cross section is nbarn/sr             //
////////////////////////////////////////////////////////////
#include "XEMC_Const.h"
#include "XEMC_Born.h"
#include "XEM_Elastic.h"
...
class XEMCEvent
{
 ...
 private:
  ...
  {    
    ...
    //    cout<<"event: "<<Target.A<<"  "<<Target.Z<<endl;
    cs_el=gCal_Elastic((int)(Target.A+0.5),(int)(Target.Z+0.5), E_s,Angle);
    

    if ( IsRadCor && cs_Final>= 1e-10 &&!(std::isnan(cs_Final)))
      {
	//all nbarn/sr
	cs_q = cs_Final;
 ...
 private:
  ...
  double _sigma_q(const double& aEs,const double& aEp)
  {
    ...
    if(IsQFS){
      ...
      //              6->QE_DIS+F1F2IN06_XEM+Coulomb Correction
 ...
 private:
  ...
  double relativeMass(int A, int Z){
    double i=A;
    switch (A){
    case 1:   i=1.008665;break;
    case 2:   i=2.014102;break;
    case 3:   {if(Z==1) i=3.016049; else i=3.016029;break;}
    case 4:   i=4.002603;break;
    case 12:  i=12;break;
    case 16:  i=15.994914;break;
    case 27:  i=26.981539;break;
    case 40:  i=40.078;break;
    case 56:  i=55.845;break;
    case 64:  i=63.546;break;
    case 108: i=107.8682;break;
    case 197: i=196.966569;break;
    default:  cout<<"---please add the atomic mass for "<< A<<" in XEMCEvent.h\n";
  ...
  void SetMaterial(Material& aMaterial)
  {
    ...
    //   cout<<"target atomic mass = "<<aMaterial.A<<endl;
    //  aMaterial.M=AMU*relativeMass(aMaterial.A,aMaterial.Z);
 ...
 public:
  ...
  double cs_el; // elastic cross section from MCEEP
