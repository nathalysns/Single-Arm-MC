...
static const double ELECTRON_MASS=0.510998946; //MeV
static const double M2=ELECTRON_MASS*ELECTRON_MASS; //MeV
static const double AMU=931.4940954; //MeV
static const double PROTON_MASS=938.2720813; //MeV
static const double DELTA_MASS=1232.; //MeV
static const double PI_MASS=139.57; //pi+-, MeV
...
static const double HBARC=197.3269788; //hbar*c MeV fm
